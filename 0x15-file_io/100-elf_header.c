...
/**
 * check_elf - It checks whether or not a file is an ELF file
 * @e_ident: The pointer that points to an array containing ELF magic numbers
 ...
 * @e_ident: A pointer that points to an array containing the ELF ABI version
 */
...
/**
 * print_type - It prints the ELF header type
 * @e_type: The ELF type
 * @e_ident: A pointer that points to an array containing the ELF class
 */
...
/**
 * print_entry - It prints the ELF header entry point
 ...
 * If the file can't be closed - exit code 98
 */
